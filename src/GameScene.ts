...
export class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    const createCircle = (key: string, color: number, diameter: number) => {
    ...
    const createCannonShape = (
      ...
      // 4. Fill the polygon defined by the points
    ...
    createCannonShape(CANNON_SPRITE, 0xaaaaaa, 30, 10);
    createCannonShape(CANNON_SHADOW_SPRITE, 0x000000, 30, 10);
    createCircle(BULLET_SPRITE, 0xff0000, 10);
    createCircle(BULLET_SHADOW_SPRITE, 0x000000, 8);
  }
